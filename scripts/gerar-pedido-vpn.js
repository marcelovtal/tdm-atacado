...
/** CPQ invoke (mesmo padrão de gerar-pedido-link-dedicado.js): DuplicateVPNValues etc. */
...
async function runLeadFlow(instanceUrl, accessToken, cookie) {
  ...
  console.log('[E2E] 4. PATCH Organization (vtal_LXD_FantasyName__c + Billing alinhado ao LD / IP Connect)...');
