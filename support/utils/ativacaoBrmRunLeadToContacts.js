 ...
 */
async function runLeadToContactsStep7(apiCall, fail) {
  console.log('[ATIVACAO] 1. Criando Lead...');
  ...
  console.log('[ATIVACAO] 2. Patch Lead Status Contacted...');
  ...
  console.log('[ATIVACAO] 3. Converter Lead...');
  ...
  console.log('[ATIVACAO] 4. PATCH Organization (vtal_LXD_FantasyName__c + Billing)...');
  ...
  console.log('[ATIVACAO] 5. PATCH Business...');
  ...
  console.log('[ATIVACAO] 6. PATCH Billing...');
  ...
  console.log('[ATIVACAO] 7. Criando 2 Contatos...');
